      ...
      >
        ...
        >
          ...
          <GiftedForm.SelectWidget name='gender' title='Gender' multiple={false}>
            <GiftedForm.OptionWidget image={require('../assets/icons/app-icon.png')} title='Female' value='F'/>
            <GiftedForm.OptionWidget image={require('../assets/icons/app-icon.png')} title='Male' value='M'/>
